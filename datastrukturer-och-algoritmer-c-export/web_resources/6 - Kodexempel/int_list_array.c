 ...
 */
list_position list_previous(const list * l,
                            const list_position pos)
{
	return pos - 1;
}
 ...
 */
list_position list_insert(list * l, int data,
                          const list_position pos)
{
	// Move elements at position pos and later forward.
	bcopy(l->values+pos,l->values+pos+1,
 ...
 */
list_position list_remove(list *l,
                          const list_position pos)
{
	// Move elements at position pos and later forward.
	bcopy(l->values+pos+1,l->values+pos,
              sizeof(int)*(l->last_used_pos-pos));
